...
The original image and two example images with the different parameter setups are shown in the following figures \ref{fig:fish}, \ref{fig:hog8} and \ref{fig:hog16}.
...
\includegraphics[scale=0.5]{images/hog/256_256_16}
\end{figure}
